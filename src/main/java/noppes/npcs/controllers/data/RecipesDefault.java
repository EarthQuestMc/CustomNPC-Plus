    ...
    public static void loadDefaultRecipes(int i) {
        ...
        if (i < 1) {
            if (!ConfigItem.DisableExtraBlock) {
                ...
                addRecipe("noppes.npcs.client.model.blocks.Stool Wood1", new ItemStack(CustomItems.stool, 1, 0), false, "XXX", " X ", "X X", 'X', new ItemStack(Blocks.planks, 1, 0));
                addRecipe("noppes.npcs.client.model.blocks.Stool Wood2", new ItemStack(CustomItems.stool, 1, 1), false, "XXX", " X ", "X X", 'X', new ItemStack(Blocks.planks, 1, 1));
                addRecipe("noppes.npcs.client.model.blocks.Stool Wood3", new ItemStack(CustomItems.stool, 1, 2), false, "XXX", " X ", "X X", 'X', new ItemStack(Blocks.planks, 1, 2));
                addRecipe("noppes.npcs.client.model.blocks.Stool Wood4", new ItemStack(CustomItems.stool, 1, 3), false, "XXX", " X ", "X X", 'X', new ItemStack(Blocks.planks, 1, 3));
                addRecipe("noppes.npcs.client.model.blocks.Stool Wood5", new ItemStack(CustomItems.stool, 1, 4), false, "XXX", " X ", "X X", 'X', new ItemStack(Blocks.planks, 1, 4));
                addRecipe("noppes.npcs.client.model.blocks.Stool Wood6", new ItemStack(CustomItems.stool, 1, 5), false, "XXX", " X ", "X X", 'X', new ItemStack(Blocks.planks, 1, 5));
