...
public class CustomItems {
    ...
    public static void load() {
        ...
        if (!ConfigItem.DisableExtraBlock) {
            ...
            GameRegistry.registerTileEntity(TileShortLamp.class, "TileNPCShortLamp");
        ...
        CustomNpcs.proxy.blockRegister(redstoneBlock, "npcRedstoneBlock");
        CustomNpcs.proxy.blockRegister(carpentyBench, ItemNpcBlock.class, "npcCarpentyBench");
        CustomNpcs.proxy.blockRegister(mailbox, ItemBlock.class, "npcMailbox");
        CustomNpcs.proxy.blockRegister(waypoint, "npcWaypoint");
        CustomNpcs.proxy.blockRegister(border, "npcBorder");
        CustomNpcs.proxy.blockRegister(scripted, "npcScripted");
        ...
        if (!ConfigItem.DisableExtraBlock) {
            ...
            shortLamp = new BlockShortLamp().setBlockName("npcShortLamp").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setCreativeTab(tabBlocks);
            ...
            CustomNpcs.proxy.blockRegister(blood, "npcBloodBlock");
            CustomNpcs.proxy.blockRegister(banner, ItemBlock.class, "npcBanner");
            CustomNpcs.proxy.blockRegister(wallBanner, ItemBlock.class, "npcWallBanner");
            CustomNpcs.proxy.blockRegister(tallLamp, ItemBlock.class, "npcTallLamp");
            CustomNpcs.proxy.blockRegister(shortLamp, ItemBlock.class, "npcShortLamp");
            CustomNpcs.proxy.blockRegister(chair, ItemBlock.class, "npcChair");
            CustomNpcs.proxy.blockRegister(crate, ItemBlock.class, "npcCrate");
            CustomNpcs.proxy.blockRegister(weaponsRack, ItemBlock.class, "npcWeaponRack");
            CustomNpcs.proxy.blockRegister(couchWool, ItemBlock.class, "npcCouchWool");
            CustomNpcs.proxy.blockRegister(couchWood, ItemBlock.class, "npcCouchWood");
            CustomNpcs.proxy.blockRegister(table, ItemBlock.class, "npcTable");
            CustomNpcs.proxy.blockRegister(stool, ItemBlock.class, "npcStool");
            CustomNpcs.proxy.blockRegister(placeholder, ItemPlaceholder.class, "npcPlaceholder");
            CustomNpcs.proxy.blockRegister(bigsign, "npcBigSign");
            CustomNpcs.proxy.blockRegister(barrel, ItemBlock.class, "npcBarrel");
            CustomNpcs.proxy.blockRegister(tombstone, ItemBlock.class, "npcTombstone");
            CustomNpcs.proxy.blockRegister(shelf, ItemBlock.class, "npcShelf");
            CustomNpcs.proxy.blockRegister(sign, ItemBlock.class, "npcSign");
            CustomNpcs.proxy.blockRegister(beam, ItemBlock.class, "npcBeam");
            CustomNpcs.proxy.blockRegister(book, "npcBook");
            CustomNpcs.proxy.blockRegister(pedestal, ItemBlock.class, "npcPedestal");
            CustomNpcs.proxy.blockRegister(crystal, ItemNpcColored.class, "npcCrystalBlock");
            CustomNpcs.proxy.blockRegister(campfire, "npcCampfire");
            CustomNpcs.proxy.blockRegister(lantern, "npcLamp");
            CustomNpcs.proxy.blockRegister(candle, "npcCandle");
            CustomNpcs.proxy.blockRegister(campfire_unlit, "npcCampfireUnlit");
            CustomNpcs.proxy.blockRegister(candle_unlit, "npcLampUnlit");
            CustomNpcs.proxy.blockRegister(lantern_unlit, "npcCandleUnlit");
            ...
            Item.getItemFromBlock(shortLamp).setHasSubtypes(true);
        ...
        if (!ConfigItem.DisableExtraItems) {
            ...
            earthElement = new ItemNpcInterface(26959).setUnlocalizedName("npcEarthElement").setCreativeTab(CustomItems.tabMisc).setTextureName("customnpcs:npcEarthElement");
            waterElement = new ItemNpcInterface(26960).setUnlocalizedName("npcWaterElement").setCreativeTab(CustomItems.tabMisc).setTextureName("customnpcs:npcWaterElement");
            fireElement = new ItemNpcInterface(26961).setUnlocalizedName("npcFireElement").setCreativeTab(CustomItems.tabMisc).setTextureName("customnpcs:npcFireElement");
            airElement = new ItemNpcInterface(26962).setUnlocalizedName("npcAirElement").setCreativeTab(CustomItems.tabMisc).setTextureName("customnpcs:npcAirElement");
